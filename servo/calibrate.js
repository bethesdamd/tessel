/*********************************************
From: https://github.com/tessel/servo-pca9685/blob/master/examples/calibrate.js
This servo module demo allows you to find the upper and lower PWM bounds your servo uses to 
represent its maximum and minimum position. These values should then be fed into that 
physical motor's `configure` function in order to enable the motor to be commanded through 
its full range.
Run `tessel run calibrate.js` and try values  until you find the upper and lower limits.
WARNING: If you use this code carelessly, you run the risk of breaking your servo. Work 
